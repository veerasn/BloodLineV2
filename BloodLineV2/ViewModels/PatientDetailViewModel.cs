...
namespace BloodLineV2.ViewModels
{
    public class PatientDetailViewModel
    {
        ...
        public string PATNUMBERSHORT
        {
            get
            {
                var x = PATNUMBER.TrimStart(new char[] { '0' });
                x = x.PadLeft(8, '0');
                return PATNUMBER != null ? x : "";
            }
        }
        ...
        public string EI
        {
            get
            {
                switch (MANDATORYXMATCH)
                {
                    case 0:
                        { return MANDATORYXMATCH != null ? "EI FAIL" : "?"; }
                    case 1:
                        { return MANDATORYXMATCH != null ? "EI PASS" : "?"; }
                    case 2:
                        { return MANDATORYXMATCH != null ? "EI FAIL" : "?"; }
                    default:
                        { return MANDATORYXMATCH != null ? "?" : "?"; }
                }
            }
        }
