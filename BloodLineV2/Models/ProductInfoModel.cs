    ...
    public class ProductInfoModel
    {
        ...
        public ProductInfoModel()
        {
            this.bloodproducts = new List<ProductInfo>()
            {
                ...
                new ProductInfo{
                    Id = "PLTLR",
                    Name = "Single Donor Apheresis Platelet, Leucodepleted, Irradiated",
                    Charge = 530.00,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 99999,
                ...
                new ProductInfo{
                    Id = "PLTPL-LD",
                    Name = "Random Donor Platelet, Pooled, Leucodepleted, Irradiated",
                    Charge = 450.00,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 99999,
                ...
                new ProductInfo{
                    Id = "PLLR-HLA",
                    Name = "HLA-compatible Single Donor Apheresis Platelet, Leucodepleted, Irradiated",
                    Charge = 850.00,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 99999,
                ...
                new ProductInfo{
                    Id = "PLTLR-PP",
                    Name = "Pedi-pack, Single Donor Apheresis Platelet, Leucodepleted, Irradiated",
                    Charge = 250.00,
                    Leucodeplete = 1,
                    Irradiate = 0,
                    Upperage = 365,
